...
export const PlacePage: React.FC = () => {
  ...
  return (
    <Box sx={{ 
      backgroundImage: `linear-gradient(rgba(92, 92, 92, 0.34), rgba(41, 41, 41, 0.68)), url(${usaBackground}
      )`,
      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ mb: 4, mx: 1 }}>
          <Typography 
            variant="h3" 
            component="h1" 
            sx={{ fontWeight: 800, color: '#fefaef', mb: 4.5, letterSpacing: '-0.02em' }}
          >
            {product.name}
          </Typography>
          <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 2, color: '#fefaef' }}>
            {product.location && (
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                <MapPinIcon sx={{ color: '#fefaef', fontSize: 20 }} />
